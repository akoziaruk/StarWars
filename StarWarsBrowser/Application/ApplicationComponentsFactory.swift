...
final class ApplicationComponentsFactory {
    fileprivate lazy var useCase: MainUseCaseType = MainUseCase(repositoryService: servicesProvider.repositoryService, imageLoaderService: servicesProvider.imageLoader)
